...
![Demo of the Quiz App](https://github.com/Tulsi-Kavathiya/quiz_lab/blob/main/QuizLab.gif)
...
```
git clone https://github.com/Tulsi-Kavathiya/quiz_lab.git
cd quiz_lab
```
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-blue?logo=linkedin&logoColor=white)](https://www.linkedin.com/in/tulsi-kavathiya/)
